...
describe('Park Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'park', component: ParkComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.parks?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to parkService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getParkIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getParkIdentifier).toHaveBeenCalledWith(entity);
